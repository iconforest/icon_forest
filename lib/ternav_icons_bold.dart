...
/// Ternav icons (bold) icons (184 icons)
///
/// - build svg for ternav_icons_bold icon libraries
/// - constants link to svg icon resources
class TernavIconsBold extends StatelessWidget {
  ...
  const TernavIconsBold(this.assetName,
      {Key? key,
