...
/// Ternav icons (light outline) (184 icons)
///
/// - build svg for ternav_icons_light_outline icon libraries
/// - constants link to svg icon resources
class TernavIconsLightOutline extends StatelessWidget {
  ...
  const TernavIconsLightOutline(this.assetName,
      {Key? key,
  ...
  static const String RotateRight_1 = 'Rotate Right-1.svg';
