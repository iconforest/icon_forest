...
/// Ternav icons (light) icons (184 icons)
///
/// - build svg for ternav_icons_light icon libraries
/// - constants link to svg icon resources
class TernavIconsLight extends StatelessWidget {
  ...
  const TernavIconsLight(this.assetName,
      {Key? key,
  ...
  static const String bag2 = 'bag 2.svg';
