          ...
          children: [
            ...
            ListTile(
                leading: Padding(
                  ...
                  child: Image.asset('readme_images/download/appstore.png'),
                ),
            ...
            ListTile(
                leading: Padding(
                  padding: const EdgeInsets.all(8.0),
                  child: Image.asset('readme_images/download/googleplay.png'),
                ),
                title: const Text('Free icon search app'),
                onTap: () {
                  launchUrl(Uri.parse(
            ...
            ListTile(
                leading: Padding(
                  padding: const EdgeInsets.all(8.0),
                  child: Image.asset('readme_images/download/apk.png'),
                ),
                title: const Text('Free icon search app'),
                onTap: () {
                  launchUrl(Uri.parse(
